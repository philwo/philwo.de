...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.image_uuid'
        db.alter_column('articles_article', 'image_uuid', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Article.image_uuid'
        db.alter_column('articles_article', 'image_uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=32, unique=True))
    ...
    models = {
        'articles.article': {
            ...
            'image_uuid': ('django.db.models.fields.CharField', [], {'max_length': '32', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
