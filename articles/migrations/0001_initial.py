...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('articles_article', (
            ...
            ('image_uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, blank=True)),
        ))
    ...
    models = {
        'articles.article': {
            ...
            'image_uuid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32', 'blank': 'True'}),
